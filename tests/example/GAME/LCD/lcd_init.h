...
#define LCD_RES_Clr() GPIO_REG(GPIO_DATA) &= ~0B00000100;  // GPIO2输出低
#define LCD_RES_Set() GPIO_REG(GPIO_DATA) |= 0B00000100;  // GPIO2输出高

#define LCD_DC_Clr() GPIO_REG(GPIO_DATA) &= ~0B00001000;  // GPIO3输出低
#define LCD_DC_Set() GPIO_REG(GPIO_DATA) |= 0B00001000;  // GPIO3输出高

#define LCD_BLK_Clr()  GPIO_REG(GPIO_DATA) &= ~0B00010000;  // GPIO4输出低
#define LCD_BLK_Set()  GPIO_REG(GPIO_DATA) |= 0B00010000;  // GPIO4输出高
